...
from config import DEEPSDF_VQ_MODEL


class DeepSDFDecoder(nn.Module):
    """Decoder used by the VQ-DeepSDF pipeline."""

    def __init__(
        self,
        latent_size=DEEPSDF_VQ_MODEL["latent_size"],
        hidden_size=DEEPSDF_VQ_MODEL["hidden_size"],
        num_layers=DEEPSDF_VQ_MODEL["num_layers"],
        dims=DEEPSDF_VQ_MODEL["dims"],
        dropout=DEEPSDF_VQ_MODEL["dropout"],
        dropout_prob=DEEPSDF_VQ_MODEL["dropout_prob"],
        norm_layers=DEEPSDF_VQ_MODEL["norm_layers"],
        latent_in=DEEPSDF_VQ_MODEL["latent_in"],
        weight_norm=DEEPSDF_VQ_MODEL["weight_norm"],
        xyz_in_all=DEEPSDF_VQ_MODEL["xyz_in_all"],
        use_tanh=DEEPSDF_VQ_MODEL["use_tanh"],
        latent_dropout=DEEPSDF_VQ_MODEL["latent_dropout"],
    ):
        super().__init__()
